          ...
          >
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-3 py-2 text-gray-500 bg-white outline-none border border-borderColor focus:border-indigo-600 shadow-sm rounded-xl"
              />
            </div>
            <button className="block w-auto py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700 active:shadow-none rounded-xl shadow">
              Subscribe
            </button>
          </form>
        </div>
