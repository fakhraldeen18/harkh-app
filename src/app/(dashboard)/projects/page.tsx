...
const Page = () => {
  ...
  // // Queries
  // const { data: projects, error } = useQuery<TypeProjects[]>({
  //   queryKey: ["project"],
  //   queryFn: getProjects,
  // });
  ...
  //   const readDocuments = documents?.filter((doc) => doc.fromId === project.id);
  ...
  //                 <SelectItem value="Planning">Planed projects</SelectItem>
  //                 <SelectItem value="Completion">completed projects</SelectItem>
  //               </SelectGroup>
  //             </SelectContent>
  //           </Select>
